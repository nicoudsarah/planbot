...
import ExcellenceCenterTable from "./components/ExcellenceCenterTable";
...
export const projectsTypeDatas = async () => {
    return new Promise((resolve, _) => {
